...
import 'psp_pre_harvest_detail_screen.dart'; // Import ini sekarang akan terpakai
import 'psp_pre_harvest_listview_builder.dart';

class PspPreHarvestScreen extends StatefulWidget {
  ...
  @override
  PspPreHarvestScreenState createState() => PspPreHarvestScreenState();
}

class PspPreHarvestScreenState extends State<PspPreHarvestScreen> {
  late final GoogleSheetsApi _googleSheetsApi;
  final _worksheetTitle = 'Generative'; // TETAP MENGAMBIL DARI SHEET GENERATIVE
  ...
  final Color _primaryColor = Colors.red.shade900; // Warna Merah Tua
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // 2. Decorative Blob (Top Right) - RED THEME
          Positioned(
            top: -50,
            right: -50,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.red.shade200.withOpacity(0.3), blurRadius: 60, spreadRadius: 10),
                ],
              ),
            ),
          ),
            ...
            children: [
              ...
              Expanded(
                child: LiquidPullToRefresh(
                  ...
                  color: _primaryColor, // Pull refresh warna merah
                  backgroundColor: Colors.white,
                  ...
                  // GUNAKAN PRE-HARVEST LISTVIEW BUILDER
                      : PspPreHarvestListViewBuilder(
                    filteredData: _filteredData,
                    selectedRegion: widget.region,
                    onItemTap: (fieldNumber) {
                      // --- PERBAIKAN DI SINI ---
                      // Navigasi sekarang diaktifkan (uncommented)
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PspPreHarvestDetailScreen(
  ...
  Widget _buildFloatingSummaryDock() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _primaryColor.withOpacity(0.9), // Warna Merah Tua
