...
import 'psp_harvest_detail_screen.dart'; // Import detail harvest
import 'psp_harvest_listview_builder.dart'; // Import list builder harvest

class PspHarvestScreen extends StatefulWidget {
  final String spreadsheetId;
  final String region;
  final String? selectedZone;
  final String? selectedFA;

  const PspHarvestScreen({
    super.key,
  ...
  @override
  PspHarvestScreenState createState() => PspHarvestScreenState();
}

class PspHarvestScreenState extends State<PspHarvestScreen> {
  late final GoogleSheetsApi _googleSheetsApi;
  final _worksheetTitle = 'Generative'; // Tetap Generative
  ...
  // --- THEME COLORS: HARVEST (AMBER/GOLD) ---
  final Color _primaryColor = Colors.amber.shade800; // Emas/Kuning Tua
  final Color _bgGradientTop = const Color(0xFFFFF8E1); // Amber 50
  final Color _bgGradientBottom = const Color(0xFFFAFAFA); // Putih
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.amber.shade200.withOpacity(0.3), blurRadius: 60, spreadRadius: 10),
                ],
              ),
            ),
          ),
                  ...
                  // BUILDER HARVEST
                    ...
                    onItemTap: (fieldNumber) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PspHarvestDetailScreen(
  ...
  Widget _buildFloatingSummaryDock() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _primaryColor.withOpacity(0.9), // Gold/Amber
