...
class PspVisit3Screen extends StatefulWidget {
  final String spreadsheetId;
  final String fieldNumber;
  final String region;

  const PspVisit3Screen({
    super.key,
  ...
  @override
  State<PspVisit3Screen> createState() => _PspVisit3ScreenState();
}

class _PspVisit3ScreenState extends State<PspVisit3Screen> {
  ...
  Future<void> _submitData() async {
    ...
    try {
      // MAPPING KOLOM VISIT 3 (BN, BP - BV)
      // BN=66, BP=68 ... BV=74
      Map<int, String> updates = {
        66: _visitDateController.text,          // BN: Date Of Visit 3
        // BO (67) Skipped
        68: _selectedCropRate ?? "-",           // BP: Veg Crop Rate
        69: _selectedUniformity ?? "-",         // BQ: Veg Crop Uniformity
        70: _selectedHealth ?? "-",             // BR: Veg Crop Health
        71: _plantPerfRemarksController.text,   // BS: Plant Performance Remarks
        72: _envRemarksController.text,         // BT: Environment Remarks
        73: _selectedRecommendation ?? "-",     // BU: Recommendation
        74: _recPldAreaController.text,         // BV: Recommendation PLD (Ha)
      };

      await _googleSheetsApi.updateSpecificCells('Vegetative', _targetRowIndex!, updates);

      if (mounted) {
        _showSnackBar("Visit 3 Data Saved Successfully!", isError: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Visit 3 Checklist", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // --- SECTION 1: DATE & GPS ---
                    _buildSectionHeader("Schedule Check", Icons.calendar_month_rounded),
                    ...
                    _buildGlassContainer(
                      children: [
                        GestureDetector(
                          ...
                          child: AbsorbPointer(
                            child: _buildTextField(_visitDateController, "Date of Visit 3", Icons.date_range),
                          ),
                        ),
                      ],
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isSubmitting
                            ...
                            : const Text("SAVE VISIT 3", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                    ),
                  ],
                ),
