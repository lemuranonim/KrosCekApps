...
class PspGenerativeFilterOptions extends StatefulWidget {
  final String? selectedSeason;
  final List<String> seasonsList;
  final Function(String?) onSeasonChanged;

  final List<String> selectedWeekOfPspGenerative;
  final List<String> weekOfPspGenerativeList;
  final Function(List<String>) onWeekOfPspGenerativeChanged;
  ...
  const PspGenerativeFilterOptions({
    super.key,
    this.selectedSeason,
    required this.seasonsList,
    required this.onSeasonChanged,
    required this.selectedWeekOfPspGenerative,
    required this.weekOfPspGenerativeList,
    required this.onWeekOfPspGenerativeChanged,
  ...
  @override
  State<PspGenerativeFilterOptions> createState() => _PspGenerativeFilterOptionsState();
}

class _PspGenerativeFilterOptionsState extends State<PspGenerativeFilterOptions> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _selectedWeeks = List.from(widget.selectedWeekOfPspGenerative);
              ...
              Expanded(
                child: Text(
                  _selectedWeeks.isEmpty
                      ? 'Select Weeks of Psp Generative'
                  ...
                  Flexible(
                    child: Scrollbar(
                      ...
                      child: ListView.separated(
                        padding: const EdgeInsets.all(8),
                        shrinkWrap: true,
                        itemCount: widget.weekOfPspGenerativeList.length,
                        separatorBuilder: (context, index) => const Divider(height: 1),
                        itemBuilder: (context, index) {
                          final item = widget.weekOfPspGenerativeList[index];
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                widget.onWeekOfPspGenerativeChanged(_selectedWeeks);
