...
class PspGenerativeDetailScreenState extends State<PspGenerativeDetailScreen> {
  ...
  // --- THEME COLORS: GENERATIVE (Deep Orange / Amber) ---
  final Color _primaryColor = Colors.deepOrange.shade800;
  final Color _bgGradientTop = const Color(0xFFFFF3E0); // Orange 50
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. Background Gradient (Warm Tones)
          Container(
          ...
          // 2. Decorative Blob (Top Left - Orange)
          Positioned(
            top: -60,
            left: -60,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.orange.shade300.withOpacity(0.2), blurRadius: 80, spreadRadius: 20),
                ],
              ),
            ),
          ),
  ...
  // --- WIDGET: Main Header Card (Orange Theme) ---
  Widget _buildMainHeaderCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_primaryColor, Colors.orange.shade600],
      ...
      child: Stack(
        children: [
          // Background Pattern (Sun/Flower)
          Positioned(
            right: -20,
            top: -20,
            child: Icon(Icons.wb_sunny_rounded, size: 150, color: Colors.white.withOpacity(0.1)),
          ),
  ...
  List<Widget> _buildLocationList() {
    ...
    return [
      _buildInfoTile("Village (Desa)", desa, Icons.home_work_rounded, Colors.orange.shade900),
      Divider(height: 1, indent: 60, color: Colors.grey.withOpacity(0.1)),
      _buildInfoTile("District (Kecamatan)", kec, Icons.location_city_rounded, Colors.deepOrange.shade600),
      Divider(height: 1, indent: 60, color: Colors.grey.withOpacity(0.1)),
      _buildInfoTile("Regency (Kabupaten)", kab, Icons.map_rounded, Colors.brown.shade600),
      Divider(height: 1, indent: 60, color: Colors.grey.withOpacity(0.1)),
      _buildInfoTile("Zone Area", zone, Icons.flag_rounded, Colors.red.shade700),
    ];
  }
