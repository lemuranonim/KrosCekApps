...
import 'psp_generative_detail_screen.dart'; // Nanti kita buat ini
import 'psp_generative_listview_builder.dart'; // Nanti kita buat ini
...
class PspGenerativeScreenState extends State<PspGenerativeScreen> {
  ...
  final _worksheetTitle = 'Generative'; // TARGET SHEET BERUBAH
  ...
  // --- THEME COLORS: GENERATIVE (ORANGE/AMBER) ---
  final Color _primaryColor = Colors.orange.shade900;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // 2. Decorative Blob (Top Right) - ORANGE THEME
          Positioned(
            top: -50,
            right: -50,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: Colors.orange.shade200.withOpacity(0.3), blurRadius: 60, spreadRadius: 10),
                ],
              ),
            ),
          ),
            ...
            children: [
              ...
              Expanded(
                child: LiquidPullToRefresh(
                  ...
                  color: _primaryColor, // Pull refresh warna oranye
                  backgroundColor: Colors.white,
  ...
  Widget _buildFloatingSummaryDock() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _primaryColor.withOpacity(0.9), // Warna Oranye Tua
