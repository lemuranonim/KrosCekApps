...
class FormGenerative2SC extends ConsumerStatefulWidget {
  ...
  const FormGenerative2SC({super.key, required this.fieldNumber});

  @override
  ConsumerState<FormGenerative2SC> createState() => _FormGenerative2SCState();
}

class _FormGenerative2SCState extends ConsumerState<FormGenerative2SC> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: GenAppBar(
        checkpointLabel: 'Audit 2 (SC) – Process Check',
        fieldNumber: widget.fieldNumber,
        isDiscard: isDiscard,
      ...
      body: auditAsync.when(
        loading: () => AdvantaLoadingState(title: 'Memuat form audit', subtitle: 'Mengambil data inspeksi', accentColor: kGen2Color, icon: Icons.assignment_rounded),
        error: (e, _) => Center(
            child: Text('Error: $e',
