...
class FormVegetativeSC extends ConsumerStatefulWidget {
  final String fieldNumber;
  const FormVegetativeSC({super.key, required this.fieldNumber});

  @override
  ConsumerState<FormVegetativeSC> createState() => _FormVegetativeSCState();
}

class _FormVegetativeSCState extends ConsumerState<FormVegetativeSC> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: GenAppBar(
        checkpointLabel: 'Vegetative Audit (SC)',
        fieldNumber: widget.fieldNumber,
        isDiscard: isDiscard,
