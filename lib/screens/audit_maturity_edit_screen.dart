...
class AuditMaturityEditScreenState extends State<AuditMaturityEditScreen> {
  ...
  void initState() {
    ...
    _dateInspectionController = TextEditingController(text: _convertToDateIfNecessary(row[65]));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Maturity', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildDatePickerField('Date of Inspection', 65, _dateInspectionController),
                ...
                _buildTextFormField('Remarks', 70),
