...
class WeatherService {
  ...
  Future<WeatherData> loadCachedWeatherData() async {
    try {
  ...
  Future<void> saveWeatherToCache(WeatherData weatherData) async {
    try {
      final prefs = await SharedPreferences.getInstance();
      final dataToCache = weatherData.toJson();
  ...
  Future<WeatherData> fetchCurrentWeather(Position position, String locationName) async {
