...
import '../harvest/harvest_screen.dart'; // ✅ Import Harvest Screen
...
class _PreHarvestSliverListBuilderState extends State<PreHarvestSliverListBuilder> {
  ...
  // ============================================================================
  // 🆕 FUNGSI CEK FASE BERDASARKAN DAP (UNTUK PRE-HARVEST)
  // ============================================================================
  ...
  bool _isCorrectPhase(int dap) {
    return dap >= 80 && dap <= 99; // Untuk pre-harvest screen
  }
  ...
  Widget _buildPhaseWarningBanner(String currentPhase, int currentDAP, double currentGDU, List<String> row) {
    ...
    if (currentPhase == 'Vegetative') {
      ...
      message = 'ℹ️ Tanaman masih dalam Fase Vegetative ($currentDAP DAP). Pertimbangkan untuk memindahkan ke monitoring Vegetative terlebih dahulu.';
      buttonText = 'Pindah ke Vegetative';
    } else if (currentPhase == 'Generative') {
      icon = Icons.local_florist;
      color = Colors.amber.shade700;
      message = 'ℹ️ Tanaman masih dalam Fase Generative ($currentDAP DAP). Pertimbangkan untuk memindahkan ke monitoring Generative terlebih dahulu.';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          isOutOfPhase ? Icons.warning_amber : Icons.grain,
                          size: 14,
