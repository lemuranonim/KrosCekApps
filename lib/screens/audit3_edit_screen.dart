...
class Audit3EditScreenState extends State<Audit3EditScreen> {
  ...
  void initState() {
    ...
    selectedCorpHealth = row[58];
    selectedCropUniformity = row[59];
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Audit 3', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildTextFormField('Audit 3 Offtype', 55),
                _buildTextFormField('Audit 3 Volunteer', 56),
                _buildTextFormField('Audit 3 LSV', 57),
