...
class PspGenerativeScreenState extends State<PspGenerativeScreen> {
  ...
  List<String> _weekOfAuditSatuList = [];
  ...
  void _filterData() {
    setState(() {
      _filteredData = _sheetData.where((row) {
        ...
        final weekOfAuditSatu = getValue(row, 29, '');
        ...
        bool matchesSearchQuery = fieldNumber.contains(_searchQuery) ||
            ...
            getGenerativeStatus(
                getValue(row, 74, ""), // Kolom "Cek Result"
                getValue(row, 76, "")  // Kolom "Cek Proses"
        ...
        child: _isLoading
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: ListTile(
                leading: Hero(
                  tag: 'generative_${getValue(row, 2, "Unknown")}', // Pastikan tag unik untuk tiap item
                  child: Image.asset(
