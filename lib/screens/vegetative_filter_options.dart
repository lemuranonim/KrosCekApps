...
class VegetativeFilterOptions extends StatefulWidget {
  ...
  final String? selectedWeekOfVegetative;
  final List<String> weekOfVegetativeList;
  final Function(String?) onWeekOfVegetativeChanged;
...
class _VegetativeFilterOptionsState extends State<VegetativeFilterOptions> with SingleTickerProviderStateMixin {
  ...
  String? _selectedWeekOfVegetative;
  ...
  void initState() {
    ...
    _selectedWeekOfVegetative = widget.selectedWeekOfVegetative;
  ...
  Widget _buildFilterCount() {
    ...
    if (_selectedWeekOfVegetative != null) count++;
  ...
  Widget _buildWeekFilter() {
    return _buildDropdownFilter(
      ...
      items: ['All'] + widget.weekOfVegetativeList,
      icon: Icons.date_range,
      hintText: 'Select Week of Vegetative',
      onChanged: (value) {
        setState(() {
          _selectedWeekOfVegetative = value == 'All' ? null : value;
        });
      },
    );
  }
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                widget.onWeekOfVegetativeChanged(_selectedWeekOfVegetative);
