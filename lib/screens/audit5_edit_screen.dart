...
class Audit5EditScreenState extends State<Audit5EditScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Audit 5', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildDatePickerField('Date of Audit 5', 30, _dateAuditController),
