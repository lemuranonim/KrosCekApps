...
class Audit2EditScreenState extends State<Audit2EditScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Audit 2', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildTextFormField('Audit 2 Offtype', 46),
                _buildTextFormField('Audit 2 Volunteer', 47),
                _buildTextFormField('Audit 2 LSV', 48),
