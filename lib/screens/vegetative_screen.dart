  ...
  Future<void> _loadSheetData({bool refresh = false}) async {
    ...
    try {
      ...
      setState(() {
        ...
        // Update total Effective Area (Ha) calculation
        ...
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setState) {
            return VegetativeFilterOptions(
              ...
              selectedWeekOfVegetative: _selectedWeekOfVegetative,
              weekOfVegetativeList: _weekOfVegetativeList,
              onWeekOfVegetativeChanged: (value) {
                _selectedWeekOfVegetative = value;
              },
          ...
          IconButton(
            icon: Stack(
              children: [
                ...
                if (_selectedSeason != null || _selectedWeekOfVegetative != null || _selectedFA.isNotEmpty)
                  Positioned(
                    right: 0,
                    top: 0,
                    child: Container(
