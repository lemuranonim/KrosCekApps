...
class PspGenerativeMapView extends StatefulWidget {
  final List<List<String>> filteredData;
  final String? selectedRegion;
  final Map<String, int> activityCounts;

  const PspGenerativeMapView({
    super.key,
  ...
  @override
  State<PspGenerativeMapView> createState() => _PspGenerativeMapViewState();
}

class _PspGenerativeMapViewState extends State<PspGenerativeMapView> with AutomaticKeepAliveClientMixin {
  ...
  @override
  void didUpdateWidget(PspGenerativeMapView oldWidget) {
