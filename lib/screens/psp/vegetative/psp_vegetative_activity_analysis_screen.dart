...
class PspVegetativeActivityAnalysisScreen extends StatefulWidget {
  final Map<String, int> activityCounts;
  final Map<String, List<DateTime>> activityTimestamps;
  final List<List<String>> pspVegetativeData;
  final String? selectedRegion;

  const PspVegetativeActivityAnalysisScreen({
    super.key,
    required this.activityCounts,
    required this.activityTimestamps,
    required this.pspVegetativeData,
    this.selectedRegion,
  });

  @override
  State<PspVegetativeActivityAnalysisScreen> createState() => _PspVegetativeActivityAnalysisScreenState();
}

class _PspVegetativeActivityAnalysisScreenState extends State<PspVegetativeActivityAnalysisScreen> with SingleTickerProviderStateMixin {
  ...
  void _calculateStatistics() {
    // Basic counts
    _totalFields = widget.pspVegetativeData.length;
    ...
    for (var row in widget.pspVegetativeData) {
  ...
  List<List<String>> _getFilteredData() {
    return widget.pspVegetativeData.where((row) {
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 4),
              Text(
                'Shows summary statistics and key metrics about Psp Vegetative activity. The cards display information about activity status, audit status, and area analysis.',
              ),
              SizedBox(height: 12),
