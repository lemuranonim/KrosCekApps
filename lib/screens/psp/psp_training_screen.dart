...
import 'psp_training_sheet_api.dart'; // Import TrainingSheetApi

class PspTrainingScreen extends StatefulWidget {
  final Function(List<String>) onSave;

  const PspTrainingScreen({super.key, required this.onSave});

  @override
  PspTrainingScreenState createState() => PspTrainingScreenState();
}

class PspTrainingScreenState extends State<PspTrainingScreen> {
  late final PspTrainingSheetApi _trainingSheetApi;
  ...
  void initState() {
    super.initState();
    _trainingSheetApi = PspTrainingSheetApi(_spreadsheetId); // Inisialisasi hanya sekali
