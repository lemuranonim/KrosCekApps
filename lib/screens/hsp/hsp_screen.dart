...
class HspScreen extends StatefulWidget {
  const HspScreen({super.key});

  @override
  HspScreenState createState() => HspScreenState();
}

class HspScreenState extends State<HspScreen>
  ...
  void _setupRealTimeListeners() {
    ...
    getHSPFilterStream().listen((regions) {
      if (mounted) {
        setState(() {
  ...
  // Stream untuk mendapatkan data HSP filter secara real-time
  Stream<List<String>> getHSPFilterStream() {
    return FirebaseFirestore.instance
        .collection('config')
        .doc('filter')
        .snapshots()
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  WeatherWidget(greeting: _greeting),
                  const SizedBox(height: 16),
                  // Dropdown untuk memilih Region
                  StreamBuilder<List<String>>(
                    stream: getHSPFilterStream(),
