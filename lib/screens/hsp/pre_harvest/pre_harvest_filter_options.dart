...
class PreHarvestFilterOptions extends StatefulWidget {
  final String? selectedSeason;
  final List<String> seasonsList;
  final Function(String?) onSeasonChanged;

  final List<String> selectedWeekOfPreHarvest;
  final List<String> weekOfPreHarvestList;
  final Function(List<String>) onWeekOfPreHarvestChanged;
  ...
  const PreHarvestFilterOptions({
    super.key,
    this.selectedSeason,
    required this.seasonsList,
    required this.onSeasonChanged,
    required this.selectedWeekOfPreHarvest,
    required this.weekOfPreHarvestList,
    required this.onWeekOfPreHarvestChanged,
    ...
    required this.onShowDiscardedFaseChanged,
  });

  @override
  State<PreHarvestFilterOptions> createState() => _PreHarvestFilterOptionsState();
}

class _PreHarvestFilterOptionsState extends State<PreHarvestFilterOptions> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _selectedWeeks = List.from(widget.selectedWeekOfPreHarvest);
                  ...
                  Flexible(
                    child: Scrollbar(
                      ...
                      child: ListView.separated(
                        padding: const EdgeInsets.all(8),
                        shrinkWrap: true,
                        itemCount: widget.weekOfPreHarvestList.length,
                        separatorBuilder: (context, index) => const Divider(height: 1),
                        itemBuilder: (context, index) {
                          final item = widget.weekOfPreHarvestList[index];
                    ...
                    child: Row(
                      ...
                      children: [
                        TextButton.icon(
                          onPressed: () {
                            setState(() {
                              _selectedWeeks = List.from(widget.weekOfPreHarvestList);
                            });
                          },
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                widget.onWeekOfPreHarvestChanged(_selectedWeeks);
