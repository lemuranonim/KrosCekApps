                      ...
                      child: PageView(
                        ...
                        children: [
                          ...
                          _buildAudit1Section(
                            ...
                            _buildDetailRow('Crop Uniformity (1)', row![40]),
                          ]),

                            // Audit 2
                          _buildAudit2Section(
                            context, 'Field Audit 2', [
                            _buildDetailRow('Date of Audit 2 (dd/MM)', _convertToDateIfNecessary(row![41])),
                            _buildDetailRow('Female Shed.', row![43]),
                            _buildDetailRow('Shedding Offtype & CVL M', row![44]),
                            _buildDetailRow('Shedding Offtype & CVL F', row![45]),
                            _buildDetailRow('Crop Uniformity (2)', row![46]),
                          ]),

                            // Audit 3
                          _buildAudit3Section(
                              context, 'Field Audit 3', [
                            _buildDetailRow('Date of Audit 3 (dd/MM)', _convertToDateIfNecessary(row![47])),
                            _buildDetailRow('Female Shed.', row![49]),
                            _buildDetailRow('Shedding Offtype & CVL M', row![50]),
                            _buildDetailRow('Shedding Offtype & CVL F', row![51]),
                            _buildDetailRow('StandingCropOfftype&CVLm', row![52]),
                            _buildDetailRow('StandingCropOfftype&CVLf', row![53]),
                            _buildDetailRow('LSV Ditemukan', row![54]),
                            _buildDetailRow('Detasseling Process Observ.', row![55]),
                            _buildDetailRow('Affected by other fields', row![56]),
                            _buildDetailRow('Nick Cover', row![57]),
                            _buildDetailRow('Isolation (Y/N)', row![58]),
                            _buildDetailRow('If "YES" IsolationType', row![59]),
                            _buildDetailRow('If "YES" IsolationDist. (m)', row![60]),
                            _buildDetailRow('QPIR Applied', row![61]),
                            _buildDetailRow('Closed out Date', _convertToDateIfNecessary(row![62])),
                            _buildDetailRow('FLAGGING', row![63]),
                            _buildDetailRow('Crop Uniformity (3)', row![64]),
                            _buildDetailRow('Recommendation', row![65]),
                            _buildDetailRow('Remarks', row![66]),
                            _buildDetailRow('Recommendation PLD (Ha)', _convertToFixedDecimalIfNecessary(row![67])),
                            _buildDetailRow('Reason PLD', row![68]),
                          ]),
                        ],
                      ),
                    ),
      ...
      child: FlutterMap(
        ...
        children: [
          TileLayer(
            ...
            userAgentPackageName: 'com.generative.kroscek', // << GANTI INI JIKA PERLU
