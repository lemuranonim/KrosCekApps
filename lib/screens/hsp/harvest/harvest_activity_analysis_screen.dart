...
class HarvestActivityAnalysisScreen extends StatefulWidget {
  final Map<String, int> activityCounts;
  final Map<String, List<DateTime>> activityTimestamps;
  final List<List<String>> harvestData;
  final String? selectedRegion;

  const HarvestActivityAnalysisScreen({
    super.key,
  ...
  @override
  State<HarvestActivityAnalysisScreen> createState() => _HarvestActivityAnalysisScreenState();
}

class _HarvestActivityAnalysisScreenState extends State<HarvestActivityAnalysisScreen> with SingleTickerProviderStateMixin {
  ...
  void _calculateStatistics() {
    // Basic counts
    _totalFields = widget.harvestData.length;
    ...
    for (var row in widget.harvestData) {
  ...
  List<List<String>> _getFilteredData() {
    return widget.harvestData.where((row) {
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 4),
              Text(
                'Shows summary statistics and key metrics about Harvest activity. The cards display information about activity status, audit status, and area analysis.',
              ),
              SizedBox(height: 12),
