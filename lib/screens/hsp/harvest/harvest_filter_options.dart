...
class HarvestFilterOptions extends StatefulWidget {
  ...
  final List<String> selectedWeekOfHarvest;
  final List<String> weekOfHarvestList;
  final Function(List<String>) onWeekOfHarvestChanged;
  ...
  const HarvestFilterOptions({
    ...
    required this.selectedWeekOfHarvest,
...
class _HarvestFilterOptionsState extends State<HarvestFilterOptions> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _selectedWeeks = List.from(widget.selectedWeekOfHarvest);
                  ...
                  Flexible(
                    child: Scrollbar(
                      ...
                      child: ListView.separated(
                        padding: const EdgeInsets.all(8),
                        shrinkWrap: true,
                        itemCount: widget.weekOfHarvestList.length,
                        separatorBuilder: (context, index) => const Divider(height: 1),
                        itemBuilder: (context, index) {
                          final item = widget.weekOfHarvestList[index];
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                widget.onWeekOfHarvestChanged(_selectedWeeks);
