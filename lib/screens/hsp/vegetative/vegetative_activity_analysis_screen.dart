...
class VegetativeActivityAnalysisScreen extends StatefulWidget {
  final Map<String, int> activityCounts;
  final Map<String, List<DateTime>> activityTimestamps;
  final List<List<String>> vegetativeData;
  final String? selectedRegion;

  const VegetativeActivityAnalysisScreen({
    super.key,
  ...
  @override
  State<VegetativeActivityAnalysisScreen> createState() => _VegetativeActivityAnalysisScreenState();
}

class _VegetativeActivityAnalysisScreenState extends State<VegetativeActivityAnalysisScreen> with SingleTickerProviderStateMixin {
  ...
  void _calculateStatistics() {
    // Basic counts
    _totalFields = widget.vegetativeData.length;
    ...
    for (var row in widget.vegetativeData) {
  ...
  List<List<String>> _getFilteredData() {
    return widget.vegetativeData.where((row) {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Σ ${filteredData.length.clamp(0, 100)} lahan',
                      style: const TextStyle(
                        fontSize: 14,
                        color: AppTheme.textMedium,
                      ),
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 4),
              Text(
                'Shows summary statistics and key metrics about vegetative activity. The cards display information about activity status, audit status, and area analysis.',
              ),
              SizedBox(height: 12),
