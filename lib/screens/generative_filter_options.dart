...
class GenerativeFilterOptions extends StatefulWidget {
  ...
  final String? selectedWeekOfGenerative;
  final List<String> weekOfGenerativeList;
  final Function(String?) onWeekOfGenerativeChanged;
...
class _GenerativeFilterOptionsState extends State<GenerativeFilterOptions> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _selectedWeekOfGenerative = widget.selectedWeekOfGenerative;
  ...
  Widget _buildFilterCount() {
    ...
    if (_selectedWeekOfGenerative != null) count++;
  ...
  Widget _buildWeekFilter() {
    return _buildDropdownFilter(
      ...
      items: ['All'] + widget.weekOfGenerativeList,
      icon: Icons.date_range,
      hintText: 'Select Week of Generative',
      onChanged: (value) {
        setState(() {
          _selectedWeekOfGenerative = value == 'All' ? null : value;
        });
      },
    );
  }
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                widget.onWeekOfGenerativeChanged(_selectedWeekOfGenerative);
