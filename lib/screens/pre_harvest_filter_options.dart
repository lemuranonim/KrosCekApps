...
class PreHarvestFilterOptions extends StatefulWidget {
  ...
  final String? selectedWeekOfPreHarvest;
  final List<String> weekOfPreHarvestList;
  final Function(String?) onWeekOfPreHarvestChanged;
...
class _PreHarvestFilterOptionsState extends State<PreHarvestFilterOptions> with SingleTickerProviderStateMixin {
  ...
  String? _selectedWeekOfPreHarvest;
  ...
  void initState() {
    ...
    _selectedWeekOfPreHarvest = widget.selectedWeekOfPreHarvest;
  ...
  Widget _buildFilterCount() {
    ...
    if (_selectedWeekOfPreHarvest != null) count++;
  ...
  Widget _buildWeekFilter() {
    return _buildDropdownFilter(
      ...
      items: ['All'] + widget.weekOfPreHarvestList,
      icon: Icons.date_range,
      hintText: 'Select Week of Pre-Harvest',
      onChanged: (value) {
        setState(() {
          _selectedWeekOfPreHarvest = value == 'All' ? null : value;
        });
      },
    );
  }
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                widget.onWeekOfPreHarvestChanged(_selectedWeekOfPreHarvest);
